...
- [六.用户](#六.用户)
- [七.用户痛点](#原型2.信息设计)
- [八.用户需求:（使用的人工智能要反映到需求列表中） ](#八.用户需求:（使用的人工智能要反映到需求列表中） )
- [九.使用者交互与设计（axure产品原型）](#九.使用者交互与设计（axure产品原型）)

- [十.产品结构图](#十.产品结构图)
- [十一.API 的运用](#十一.API 的运用 )
- [十二.AI产品概率性](#十二.AI产品概率性)
- [十三.API功能对比](#十三.API功能对比)
- [十四.API使用风险评估](#十四.API使用风险评估)
- [结果预期](#结果预期)
- [附录](#附录)
